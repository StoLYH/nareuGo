#!/usr/bin/env python3
"""
Script to restore original TurtleBot3 URDF
"""

def restore_turtlebot_urdf():
    urdf_file = "/home/donggun/turtle_ws/src/turtlebot3/turtlebot3_description/urdf/turtlebot3_burger.urdf"
    
    # Original content with restored values
...
<robot name="turtlebot3_burger"
  ...
  <link name="${namespace}base_scan">
    ...
    print("TurtleBot3 URDF restored to original")

if __name__ == "__main__":
    restore_turtlebot_urdf()